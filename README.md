...
1. Import your relational response data and assign it to the corresponding data object.
2. Review and modify all sections marked with `TODO` according to your data and analysis settings.
...
The citation information will be updated once the article is formally published and its volume, issue, page range, and DOI become available.
